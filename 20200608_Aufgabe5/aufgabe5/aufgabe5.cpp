...
#include <tchar.h>
#include <ctime>
#include "D:\MyPrograms\myCppPrograms\PlativioCppCourse\20200521_Aufgabe2\Aufgabe02.1\Aufgabe02.1\Aufgabe02.2.h"
...
int WINAPI WinMain( HINSTANCE hInstance , HINSTANCE hPrevInstance , LPSTR d3 , int nCmdShow ) {
	t = WM TIME //get time , update window, which calls draw 
